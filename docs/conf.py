...
# these directories to sys.path here.
# If the directory is relative to the documentation root, use os.path.abspath to make
...
html_context = {
    "github_url": "https://www.github.com/ukgovdatascience/govuk-tech-docs-sphinx-theme",  # noqa: E501
    "gitlab_url": None,
    "conf_py_path": "docs/",
    "version": git_version,
...
html_theme_options = {"organisation": "GDS", "phase": "Discovery"}
